...
namespace WebAppointmentApi.Infrastructure.Migrations
{
    ...
    [Migration("20260822120338_AddSiteSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAppointmentApi.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ReminderConfirmedAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("ReminderSentAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("SecondReminderSentAtUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("Status", "StartAt", "ReminderSentAtUtc")
            ...
            modelBuilder.Entity("WebAppointmentApi.Domain.Entities.EmailVerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebAppointmentApi.Domain.Entities.PhoneVerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "Phone", "CreatedAtUtc");
            ...
            modelBuilder.Entity("WebAppointmentApi.Domain.Entities.SiteSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAppointmentApi.Domain.Entities.SmaCase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ProvinceSlug")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("TenantId", "ProvinceSlug", "IsVerified", "IsPublished");
