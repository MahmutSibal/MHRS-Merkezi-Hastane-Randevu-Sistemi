...
public sealed class UpdateDoctorCredentialsRequestValidator : AbstractValidator<UpdateDoctorCredentialsRequest>
{
    public UpdateDoctorCredentialsRequestValidator()
    {
        // No-op if both are null/empty (means no change)
