      ...
      <div className="flex gap-2">
        <div className="flex-1">
          <select
            ...
            className={cn(
              "h-10 w-full rounded-2xl border-2 border-slate-200 bg-white px-3 py-2 text-sm outline-none transition-all duration-200 focus:border-blue-600 focus:shadow-[0_0_0_4px_rgba(37,99,235,0.22)] dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-blue-400 dark:focus:shadow-[0_0_0_4px_rgba(147,197,253,0.22)]",
